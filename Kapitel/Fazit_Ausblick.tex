...
Bessere Hardware, die es erlaubt eine höhere Bildrate zu verarbeiten und versenden wäre von Vorteil. 
Weiterhin wäre ein eigenes WLAN im Projektraum außerhalb der limitierenden Beschränkungen an Netzwerktraffic von eduroam wünschenswert, da wir nach längerem testen unserer Methoden häufig das WLAN im Roboterauto ab- und wieder anschalten mussten.
...
%TODO Regelung
Für die Trajektorienplanung und -Regelung wäre es interessant, die genannten Probleme in \ref{sec:ctrlImpl} der Splines der alglib für Geraden weiter zu untersuchen. Gegebenenfalls wäre eine Nutzung der Trajektorienfolgeregelung mit einem schwächeren PID-Regler möglich. Dann würde im ersten Schritt der Lenkwinkel über die Krümmung der Trajektorie eingestellt und nur bei größeren Abweichungen ein PID-Regler dazugeschaltet, um den Fehler auszuregeln.
