...
%TODO: Darknet kurz erklären (Frederic)
...
%TODO: wenn so ein Begriff eingeführt wird, sollte er eigentlich auch (zumindest kurz) erläutert werden (Frederic)
...
%TODO: "Convolution", "Maxpool Layers", "subsampling" -> alles Begriffe, mit denen der Leser in aller Regel nichts direkt anfangen kann (Frederic)
...
%TODO: "Wofür stehen diese Dimensionen" -> ist eine Frage, kann hier nicht so mit Doppelpunkt verwendet werden (Frederic)
...
%TODO: was sind (unsere) "Objektklassen"? Was is die "Tiefe"? (Frederic)
